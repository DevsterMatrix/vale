...
function Boid(){
	...
	self.draw = function(ctx) {
		...
		var gradient = ctx.createLinearGradient(-25, -20, 25, -20);  // Start left, end right
    	gradient.addColorStop(0, "#FF5F5F");  // Red on the left
    	gradient.addColorStop(1, "#FFB6C1");
		ctx.fillStyle = gradient;

		// Draw a taller and thinner heart shape
		ctx.beginPath();
		ctx.moveTo(0, -20);  // Start point at the top center of the heart
	
		// Create the left side of the heart (longer and thinner)
		ctx.bezierCurveTo(-25, -30, -35, 0, 0, 20);  // Left curve
		// Create the right side of the heart (longer and thinner)
		ctx.bezierCurveTo(35, 0, 25, -30, 0, -20);  // Right curve
